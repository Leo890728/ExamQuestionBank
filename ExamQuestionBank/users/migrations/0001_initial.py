    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('student', '學生'), ('admin', '管理員')], default='student', max_length=20, verbose_name='角色')),
                ('preferred_subjects', models.JSONField(blank=True, default=list, verbose_name='偏好科目')),
